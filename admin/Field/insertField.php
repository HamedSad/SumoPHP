<?php
    ...
    $nameField = $nameFieldError = $dimensionsField = $dimensionsFieldError = $idField = $idFieldError = $urlImageField = $urlImageFieldError = "";
    ...
    if(!empty($_POST)){
       ...
       if($isSuccess){
           $db = Database::connect();
           $statement = $db->prepare("INSERT INTO field (nameField, dimensionsField, urlImageField) VALUES (?, ?, ?)");
           $statement->execute(array($nameField, $dimensionsField, $urlImageField,));
           Database::disconnect();
        ...
        <body>
            ...
            <div class="wrapp">
                ...
                <div class="formAddSport">
                    <form class="form-horizontal" role="form" action="insertField.php" method="post">
                        <fieldset>
