<?php
    ...
    $nameSport = $nameSportError = $titleSport = $titleSportError = $seasonSport = $seasonSportError = $descriptionSport = $descriptionSportError = $urlImageSport = $urlImageSportError = "";
    ...
    if(!empty($_POST)){
       ...
       if($isSuccess){
           $db = Database::connect();
           $statement = $db->prepare("INSERT INTO sports (nameSport, titleSport, seasonSport, descriptionSport, urlImageSport) VALUES (?, ?, ?, ?, ?)");
           $statement->execute(array($nameSport, $titleSport, $seasonSport, $descriptionSport, $urlImageSport));
           Database::disconnect();
